          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li><a href="jsp/buy.jsp">购买</a></li>
                <li><a href="jsp/want.jsp">购物车</a></li>
                <li><a href="jsp/msg.jsp">留言</a></li>
                <li><a href="jsp/my.jsp">个人</a></li>
              </ul>
            </div>
          </div>
        </nav>
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              <h1>最新上架</h1>
              <p>我们会为您提供最优质的服务和最快捷的保障，详情请移步“购买”专区</p>
              <p><a class="btn btn-lg btn-primary" href="jsp/buy.jsp" role="button">购买</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              <h1>销量最高</h1>
              <p>这里的数据显示换季容易使人患感冒，最近请多注意身体，点击了解详情</p>
        ...
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              <h1>给我留言</h1>
              <p>如果您有疑问，请在留言区向我们提问，我们将竭尽所能回答您的问题</p>
              <p><a class="btn btn-lg btn-primary" href="jsp/msg.jsp" role="button">留言</a></p>
            </div>
          </div>
        </div>
      </div>
