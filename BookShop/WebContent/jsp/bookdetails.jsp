      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
          ...
          <div class="row">
				...
				<c:forEach var="c" items="${sblist}">
					<img class="img-rounded" src="showpic.jsp?img=${c.url }" alt="Generic placeholder image" width="500" height="550">
            	</c:forEach>
        ...
        <div class="row row-offcanvas row-offcanvas-left">
          <div class="list-group">
			<c:forEach var="c" items="${sblist}">
          	...
          	<h4>出版商：${c.publishers }</h4>
			<h4>价格：${c.price }</h4>
			<h4>库存：${c.stock }</h4>
			<h4>简介：${c.cont }</h4>
			<h4>销量：${c.salenum }</h4>
          	<p><a class="btn btn-default" href="book.action?opttype=buybook&bid=${c.bid }" role="button">立即购买 &raquo;</a></p>
          	</c:forEach>
          </div>
