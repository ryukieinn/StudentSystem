      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <form class="navbar-form navbar-right" action='admin.action' type="post">
          	<input type=hidden name="opttype" value="queryBooks" />
            ...
            <table class="table table-striped">
              ...
              <c:forEach var="c" items="${blist}">
                <tr>
                  <td>${c.bid }</td>
                  <td>${c.bname }</td>
                  <td class="con">${c.cont }</td>
                  <td>${c.publishers }</td>
                  <td>${c.tname }</td>
                  <td>${c.stock }</td>
                  <td>${c.price }</td>
                  <td>${c.salenum }</td>
                  <td><a href="admin.action?opttype=showBooks&bid=${c.bid }"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
					修改</a>
					<a href="admin.action?opttype=deleteBooks&bid=${c.bid }"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>
					删除</a></td>
                </tr>
                </c:forEach>
              </tbody>
